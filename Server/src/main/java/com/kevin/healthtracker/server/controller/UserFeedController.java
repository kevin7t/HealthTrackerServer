...
public class UserFeedController {
    ...
    @RequestMapping(value = "/status/like/{userId}/{statusId}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseStatus(value = HttpStatus.NO_CONTENT)
    public void removeLike(@PathVariable("userId") int userId, @PathVariable("statusId") int statusId) {
        userFeedService.removeLikeFromStatus(userId, statusId);
    }
